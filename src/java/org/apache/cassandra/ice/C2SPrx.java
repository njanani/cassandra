...
public interface C2SPrx extends Ice.ObjectPrx
{
    ...
    public void Delete(String bucketID, String objID);

    public void Delete(String bucketID, String objID, java.util.Map<String, String> __ctx);
    ...
    public long Size(String bucketID, String objID);

    public long Size(String bucketID, String objID, java.util.Map<String, String> __ctx);
    ...
    public void Process(String bucketID, String objID);

    public void Process(String bucketID, String objID, java.util.Map<String, String> __ctx);
