...
public class FleCSClient {
 ...
 //     System.out.println(output);
  ...
  public int Delete(String bucket_id, String object_id)
  {
   try
   {
      c2s_prx.Delete(bucket_id, object_id);
   }
  ...
  public long Size(String bucket_id, String object_id)
  {
   try
   {
      return c2s_prx.Size(bucket_id, object_id);
   }
